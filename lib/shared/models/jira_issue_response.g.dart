...
JiraIssueResponse _$JiraIssueResponseFromJson(Map<String, dynamic> json) =>
    $checkedCreate('JiraIssueResponse', json, ($checkedConvert) {
...
JiraIssue _$JiraIssueFromJson(Map<String, dynamic> json) =>
    $checkedCreate('JiraIssue', json, ($checkedConvert) {
      final val = JiraIssue(
        fields: $checkedConvert(
          'fields',
          (v) =>
              v == null ? null : JiraFields.fromJson(v as Map<String, dynamic>),
        ),
...
JiraFields _$JiraFieldsFromJson(Map<String, dynamic> json) =>
    $checkedCreate('JiraFields', json, ($checkedConvert) {
      final val = JiraFields(
        ...
        votes: $checkedConvert(
          'votes',
          (v) =>
              v == null ? null : JiraVotes.fromJson(v as Map<String, dynamic>),
        ),
      );
      return val;
...
JiraIssueType _$JiraIssueTypeFromJson(Map<String, dynamic> json) =>
    $checkedCreate('JiraIssueType', json, ($checkedConvert) {
...
JiraStatusCategory _$JiraStatusCategoryFromJson(Map<String, dynamic> json) =>
    $checkedCreate('JiraStatusCategory', json, ($checkedConvert) {
...
JiraVotes _$JiraVotesFromJson(Map<String, dynamic> json) =>
    $checkedCreate('JiraVotes', json, ($checkedConvert) {
      final val = JiraVotes(
