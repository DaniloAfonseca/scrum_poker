...
Vote _$VoteFromJson(Map<String, dynamic> json) => $checkedCreate('Vote', json, ($checkedConvert) {
  final val = Vote(
...
Map<String, dynamic> _$VoteToJson(Vote instance) => <String, dynamic>{'userName': instance.userName, 'userId': instance.userId, 'value': _$VoteEnumEnumMap[instance.value]!};
