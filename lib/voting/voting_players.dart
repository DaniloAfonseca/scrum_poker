    ...
    return Column(
      ...
      children: [
        Container(
          ...
          child: Text(currentMessage.value, style: theme.textTheme.headlineSmall!.copyWith(color: Colors.white)),
        ),
        ...
        if (currentUsers.value.isNotEmpty)
          ...currentUsers.value.mapIndexed(
            (index, u) => Container(
              height: 50,
              width: 400,
              decoration: BoxDecoration(
                ...
                border: Border(bottom: BorderSide(color: Colors.grey[300]!), left: BorderSide(color: Colors.grey[300]!), right: BorderSide(color: Colors.grey[300]!)),
                borderRadius:
                    index == currentUsers.value.length - 1 && firebaseUser == null ? BorderRadius.only(bottomLeft: Radius.circular(6), bottomRight: Radius.circular(6)) : null,
              ),
              alignment: Alignment.centerLeft,
              padding: EdgeInsets.symmetric(horizontal: 16),
